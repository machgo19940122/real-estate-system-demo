      ...
      <div className="space-y-6">
        ...
        <Card className="border-0 shadow-lg bg-gradient-to-br from-indigo-50 to-white">
          ...
          <CardContent>
            ...
            <p className="text-xs text-gray-500 mt-2">{periodInvoices.length}件の請求から集計</p>
          </CardContent>
        </Card>
        ...
        <div className="grid gap-4 md:gap-6 md:grid-cols-2">
          <Card className="border-0 shadow-lg bg-gradient-to-br from-blue-50 to-white">
            ...
            <CardContent>
              ...
              <p className="text-xs text-gray-500 mt-2">新築 と リフォーム の合計</p>
            </CardContent>
          </Card>
          ...
          <Card className="border-0 shadow-lg bg-gradient-to-br from-emerald-50 to-white">
            ...
            <CardContent>
              ...
              <p className="text-xs text-gray-500 mt-2">新築・リフォーム・土地 の合計</p>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="grid gap-4 md:gap-6 grid-cols-2 lg:grid-cols-4">
          {(["新築", "リフォーム", "土地", "仲介料"] as RevenueCategory[]).map((category) => (
            <Card
              key={category}
            ...
            >
              ...
              <CardContent>
                ...
                <p className="text-xs text-gray-500 mt-2">{categoryTotals.counts[category]}件</p>
              </CardContent>
            </Card>
          ))}
        </div>
